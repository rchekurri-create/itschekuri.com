  ...
  return (
    <main className="pt-28">
      <MotionSection className="page-shell py-16">
        <SectionHeader eyebrow="Speaking" title="Talks, workshops, and future sessions." description="A route prepared for topics on technology strategy, AI adoption, digital transformation, solution consulting, product thinking, and implementation lessons." />
