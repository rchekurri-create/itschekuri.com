  ...
  return (
    <main className="pt-28">
      <MotionSection className="page-shell py-16">
        <SectionHeader eyebrow="Resume" title="Resume hub for consulting and solution work." description="A future-ready route for a downloadable resume, advisory focus areas, role highlights, implementation experience, and selected achievements." />
