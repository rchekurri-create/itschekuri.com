...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: site.url,
    siteName: "itschekuri",
    images: [{ url: "/images/itschekuri-lab.png", width: 1672, height: 941, alt: "Abstract itschekuri digital workshop visual" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const structuredData = {
    ...
    knowsAbout: ["Software Engineering", "Artificial Intelligence", "Cloud Computing", "Product Development", "Open Source"],
  };
